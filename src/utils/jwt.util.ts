...
export const generateRefreshToken = (payload: TRefreshTokenPayload) => jwt.sign(payload, env.JWT_REFRESH_TOKEN_SECRET, { expiresIn: "30d" })
...
export const generateAccessToken = (payload: TAccessTokenPayload) => jwt.sign(payload, env.JWT_ACCESS_TOKEN_SECRET, { expiresIn: "15m" })
